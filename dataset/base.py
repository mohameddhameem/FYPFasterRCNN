...
class Base(torch.utils.data.dataset.Dataset):
    ...
    OPTIONS = ['voc2007', 'coco2017', 'voc2007-cat-dog', 'coco2017-person', 'coco2017-car', 'coco2017-animal', 'voc2007-crack-corrosion']
    ...
    def from_name(name: str) -> Type['Base']:
        ...
        elif name == 'voc2007-crack-corrosion':
            print("choosing crack and corrosion dataset")
            from dataset.voc2007_crack_corrosion import VOC2007CrackCorrosion
            return VOC2007CrackCorrosion
        else:
            raise ValueError
